...
describe("Exchange", () =>
{
    ...
    {   const Exchange = await ethers.getContractFactory("Exchange") 
        ...
        token1 = await Token.deploy("GRIDD", "GRD", "1000000")
    ...
    {   let transaction, result
        ...
        describe("Failure", () =>
        {   it("fails for insufficant balances", async () =>
    ...
    {   let transaction, result
        ...
        describe("Success", async () => {
            ...
            it("emits an Order event", async () => 
            {
                ...
                expect(args.tokenGive).to.equal(tokens(1))
                expect(args.amountGive).to.at.least(1)
                })
            })
